...
public class OnlineAsrManager {
	...
	private static volatile OnlineAsrManager instance;
	private OnlineAsrManager(){}

	public static OnlineAsrManager getInstance() {
		if (instance ==  null) {
			instance = new OnlineAsrManager();
		}
		return instance;
	}
				...
				if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_READY)) {
					...
					try {
						...
						if ("final_result".equals(resultType)) {
							...
							if (mOnSpeechResult != null) {
								mOnSpeechResult.onResult(best_result);
							}
	...
	private OnSpeechResult mOnSpeechResult;
	public void setOnSpeechResult(OnSpeechResult onSpeechResult) {
		mOnSpeechResult = onSpeechResult;
	}
